...
**现在能打开的说明在 `00_meta/META.md` 开头。** 用户已确认也能看到 `00_meta/OLD_SUMMARY_INDEX.md`。未收到明确的“提交”二字前，不执行 Git 写入。

**2026-09-23 当前入口**：方法论只读 [`00_meta/方法论.md`](00_meta/方法论.md)；已查仓库及 Drive 的结束节点分别是 [`仓库记录总结.md`](00_meta/仓库记录总结.md)、[`Drive索引总结.md`](00_meta/Drive索引总结.md)。本轮 Git 默认不提交／推送／合并；今天两份目录的用户优先级裁决见 Drive 总结。下文旧完成、冻结或铁律如与新裁决冲突，只作历史待核记录。
...
2. [`00_meta/LOOP_AUDIT.md`](00_meta/LOOP_AUDIT.md) — 旧 loop 审计快照（现行表已迁至 `00_meta/方法论.md`） · **要文件看 [`00_meta/REQUEST_FILES.md`](00_meta/REQUEST_FILES.md)**（P0/P1/P2，按它传、别盲传）
...
3. [`00_meta/methodology.md`](00_meta/methodology.md) — 35 个旧方法标题的历史档案（现行归类见 `00_meta/方法论.md`）
